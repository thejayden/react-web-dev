...
class Contact extends Component {
    ...
    handleBlur = (field) => (evt) => {
        this.setState({ //set true to whatever field that has been modified, using onBLur later
